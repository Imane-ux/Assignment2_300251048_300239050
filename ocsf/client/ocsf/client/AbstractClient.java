...
public abstract class AbstractClient implements Runnable {
    ...
    * in some circumstances when Java refuses to send data that it thinks has been sent.
	 ...
	 * @throws IOException 
	 */
	//changed for  E49  300239050
	//added println statement which prints when the connection is closed
	...
	//changed for E49 300239050
	//added try catch which prints message that the server has shut down and quitting

...
// METHODS DESIGNED TO BE OVERRIDDEN BY CONCRETE SUBCLASSES ---------
   ...
   */
  //changed for E49 239050 
  protected void clientConnected(ConnectionToClient client) {
    System.out.println("A client is connected"); //prints message when the client connects
  }
...
//changed for E49 239050 
  synchronized protected void clientDisconnected(
    ...
    System.out.println("A client is disconnected");//prints message when the client disconnects
  }
